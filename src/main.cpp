...
static void print_teddy_compilation_stats(
...
static void print_teddy_runtime_stats(const findkey_teddy_stats& teddy_stats,
                                      size_t data_len) {
...
int main(int argc, char** argv) {
    ...
    if (collect_stats) {
        const TeddyCompilationData teddy_data =
            compile_teddy_data(key_svs, teddy_config);
